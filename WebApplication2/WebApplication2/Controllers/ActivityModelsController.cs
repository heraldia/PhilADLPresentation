...
namespace WebApplication1.Controllers
{
    public class ActivityModelsController : Controller
    {
        ...
        {
            return View(db.ActivityModels.OrderByDescending(p => p.Username).OrderByDescending(p => p.Date).ThenByDescending(p => p.Time).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "id,Username,Longitude,Latitude,Action,Date,Time,WiFi")] ActivityModels activityModels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Username,Longitude,Latitude,Action,Date,Time,WiFi")] ActivityModels activityModels)
        {
            if (ModelState.IsValid)
            {
